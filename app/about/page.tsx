...
export default function AboutPage() {
  ...
  const timelineItems = [
    {
      year: "2022",
      title: "Création de I-Tsika",
      description: "Fondation de l'agence par une équipe d'étudiants passionnés par le développement web et le design."
    },
    {
      year: "2023",
      title: "Premiers projets clients",
      description: "Réalisation de nos premiers projets professionnels pour des entreprises locales."
    },
    {
      year: "2024",
      title: "Agrandissement de l'équipe",
      description: "Intégration de nouveaux talents pour renforcer notre équipe et diversifier nos compétences."
    },
    {
      year: "2025",
      title: "Nouveaux locaux",
      description: "Installation dans de nouveaux locaux pour accueillir notre équipe grandissante et nos clients."
    }
  ];
    ...
    <main className="bg-[#070602] text-white">
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-[#d9d9d9] mb-6 leading-relaxed">
                I-Tsika est une agence web créative fondée par des passionnés du numérique en 2022. Notre mission est d'aider les entreprises à se démarquer sur internet grâce à des solutions web innovantes, accessibles et performantes.
              </p>
      ...
      <section className="py-24 bg-[#0c0c0a]">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="relative">
            {/* Vertical line */}
            <div className="absolute left-0 md:left-1/2 top-0 h-full w-px bg-[#fbc63d]/20 transform md:translate-x-px"></div>
            ...
            <div className="space-y-16">
              {timelineItems.map((item, index) => (
                ...
                >
                  <div className="flex-1 md:mr-8 md:ml-0 ml-12 md:text-right mb-4 md:mb-0">
                    {index % 2 === 0 ? (
                      <div className="md:mr-8">
                        <div className="text-4xl font-bold text-[#fbc63d] mb-2">
                          {item.year}
                        </div>
                  ...
                  {/* Dot */}
                  <div className="absolute left-0 md:left-1/2 top-2 w-8 h-8 bg-[#fbc63d] rounded-full transform -translate-x-1/2 md:-translate-x-3.5 flex items-center justify-center z-10">
                    <div className="w-3 h-3 bg-[#070602] rounded-full"></div>
                  </div>

                  <div className="flex-1 md:ml-8 md:mr-0 ml-12">
                    {index % 2 === 1 ? (
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {team.map((member, index) => (
              <motion.div
                key={index}
                className="bg-[#201f1b] rounded-2xl overflow-hidden group"
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                transition={{ duration: 0.5, delay: index * 0.1 }}
              >
                <div className="relative overflow-hidden">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#070602] to-transparent opacity-70"></div>
                </div>
                <div className="p-8 relative -mt-20">
                  <h3 className="text-xl font-semibold mb-1 text-white">
                    {member.name}
                  </h3>
                  <p className="text-[#fbc63d] mb-4">{member.role}</p>
                  <p className="text-[#d9d9d9] text-sm">{member.bio}</p>
                </div>
              </motion.div>
            ))}
          </div>
      ...
      <section className="py-20 bg-[#fbc63d] text-[#070602]">
        <div className="max-w-5xl mx-auto px-6 text-center">
          ...
          <motion.p
            ...
            transition={{ duration: 0.5, delay: 0.1 }}
          >
            Nous serions ravis de discuter de votre projet et de voir comment nous pouvons vous aider à atteindre vos objectifs.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
