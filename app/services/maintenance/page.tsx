...
export default function MaintenancePage() {
  const service = {
    ...
    longDescription: "Nous proposons des services de maintenance complets pour garantir la durabilité, la sécurité et les performances optimales de votre site web. Notre équipe veille sur votre site 24h/24 et 7j/7 pour résoudre rapidement tout problème technique et assurer que votre présence en ligne reste toujours efficace.",
    features: [
    ...
    process: [
      "Analyse des besoins de maintenance",
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <motion.p
              ...
              transition={{ duration: 0.5, delay: 0.2 }}
            >
              Une approche proactive pour garantir la pérennité de votre site web
            </motion.p>
          </div>
      ...
      <section className="py-20 bg-[#fbc63d] text-[#070602]">
        <div className="max-w-5xl mx-auto px-6 text-center">
          <motion.h2
            ...
            transition={{ duration: 0.5 }}
          >
            Besoin d'un service de maintenance fiable ?
          </motion.h2>
          <motion.p
            ...
            transition={{ duration: 0.5, delay: 0.1 }}
          >
            Contactez-nous dès aujourd'hui pour discuter de vos besoins de maintenance et obtenir un devis personnalisé.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
...
function getStepDescription(index: number) {
  const descriptions = [
    "Nous étudions les spécificités de votre site et de vos besoins pour établir un plan de maintenance sur mesure.",
    "Nous installons des outils de surveillance pour détecter tout problème potentiel avant qu'il n'impacte votre site.",
    "Nous effectuons régulièrement des mises à jour, des sauvegardes et des vérifications de sécurité selon un calendrier établi.",
    "Notre équipe réagit rapidement en cas de problème, avec un temps de réponse garanti selon votre formule de maintenance.",
    "Nous vous fournissons des rapports détaillés sur l'état de votre site et des recommandations d'améliorations continues."
  ];
