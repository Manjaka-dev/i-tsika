    ...
    <section className="relative overflow-hidden min-h-[calc(100vh-5rem)] flex items-center">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-20 md:py-28">
        ...
        >
          ...
          >
            <motion.span
              className="inline-block text-[#fbc63d] uppercase tracking-wider text-sm font-medium mb-4"
            ...
            <motion.p
              className="text-[#d9d9d9] text-lg md:text-xl max-w-md mb-12 leading-relaxed"
              variants={itemVariants}
            >
              {description}
            </motion.p>
            <motion.div variants={itemVariants}>
              <Link href={ctaLink}>
                <Button className="bg-[#fbc63d] text-[#070602] hover:bg-[#ffbb00] hover:scale-105 px-8 py-6 rounded-full text-base font-medium transition-all duration-300">
                  {ctaText}
                </Button>
              </Link>
            </motion.div>
          ...
          {/* Image or animation side (optional) */}
          <motion.div
