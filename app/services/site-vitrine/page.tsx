        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <motion.p
              ...
              transition={{ duration: 0.5, delay: 0.2 }}
            >
              Une approche éprouvée pour réaliser votre projet du concept à la livraison
            </motion.p>
          </div>
...
function getStepDescription(index: number) {
  const descriptions = [
    "Nous étudions en détail votre entreprise, vos objectifs et votre marché pour créer un site parfaitement adapté à vos besoins.",
    "Nous créons des maquettes visuelles du site pour vous permettre de visualiser le résultat final avant le développement.",
    "Nos développeurs codent votre site en utilisant les technologies les plus récentes pour garantir performance et sécurité.",
    "Nous testons rigoureusement le site sur différents appareils et optimisons son fonctionnement pour une expérience utilisateur parfaite.",
    "Nous mettons en ligne votre site et vous formons à son utilisation pour que vous puissiez le gérer en toute autonomie."
  ];
