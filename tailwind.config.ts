...
const config: Config = {
  ...
  theme: {
  	extend: {
        ...
        'elevate': {
          '0%': { transform: 'translateY(0px)', boxShadow: '0 0 0 rgba(251, 198, 61, 0)' },
          '100%': { transform: 'translateY(-5px)', boxShadow: '0 15px 25px rgba(251, 198, 61, 0.2)' }
        },
        'shimmer': {
        ...
        'grow-width': 'growWidth 1.5s ease-out',
